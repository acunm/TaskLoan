CREATE SEQUENCE IF NOT EXISTS userIdGenerator START WITH 2;
CREATE SEQUENCE IF NOT EXISTS customerIdGenerator START WITH 1;
CREATE SEQUENCE IF NOT EXISTS installmentIdGenerator START WITH 1;
CREATE SEQUENCE IF NOT EXISTS loanIdGenerator START WITH 1;
